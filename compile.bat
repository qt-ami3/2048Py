...
cmake ..\engine -Dpybind11_DIR="%PYBIND11_DIR%" -DCMAKE_BUILD_TYPE=Release
if errorlevel 1 (
...
REM Copy the built .pyd file to project root
for %%f in (Release\game2048_engine*.pyd) do copy /Y "%%f" "%SCRIPT_DIR%"
if errorlevel 1 (
